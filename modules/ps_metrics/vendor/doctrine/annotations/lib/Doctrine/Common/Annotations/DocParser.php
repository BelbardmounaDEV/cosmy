...
namespace ps_metrics_module_v4_0_5\Doctrine\Common\Annotations;

use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\Annotation\Attribute;
use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\Annotation\Attributes;
use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\Annotation\Enum;
use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\Annotation\NamedArgumentConstructor;
use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\Annotation\Target;
use ReflectionClass;
...
final class DocParser
{
    ...
    private function collectAnnotationMetadata(string $name) : void
    {
        ...
        $metadata['has_named_argument_constructor'] = $metadata['has_constructor'] && $class->implementsInterface(NamedArgumentConstructorAnnotation::class);
    ...
    private function Annotations() : array
    {
        ...
        while ($this->lexer->lookahead !== null) {
            ...
            if ($peek === null || $peek['type'] !== DocLexer::T_NAMESPACE_SEPARATOR && !in_array($peek['type'], self::$classIdentifiers, \true) || $peek['position'] !== $this->lexer->lookahead['position'] + 1) {
                $this->lexer->moveNext();
                continue;
            }
