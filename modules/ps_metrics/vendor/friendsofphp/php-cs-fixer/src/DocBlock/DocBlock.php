 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer\DocBlock;

use ps_metrics_module_v4_0_5\PhpCsFixer\Preg;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\NamespaceAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\NamespaceUseAnalysis;
/**
...
final class DocBlock
{
    ...
    public function makeMultiLine(string $indent, string $lineEnd) : void
    {
        ...
        if ('' === $lineContent) {
            $this->lines = [new Line('/**' . $lineEnd), new Line($indent . ' *' . $lineEnd), new Line($indent . ' */')];
            return;
        }
        $this->lines = [new Line('/**' . $lineEnd), new Line($indent . ' * ' . $lineContent . $lineEnd), new Line($indent . ' */')];
    }
    public function makeSingleLine() : void
    {
        ...
        $usefulLines = \array_filter($this->lines, static function (Line $line) : bool {
