...
', new VersionSpecification(80000), ['elements' => ['property' => self::SPACING_ONLY_IF_META]])]);
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('elements', 'Dictionary of `const|method|property|trait_import` => `none|one|only_if_meta` values.'))->setAllowedTypes(['array'])->setAllowedValues([static function (array $option) : bool {
