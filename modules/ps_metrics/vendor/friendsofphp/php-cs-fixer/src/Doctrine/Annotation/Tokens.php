 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer\Doctrine\Annotation;

use ps_metrics_module_v4_0_5\Doctrine\Common\Annotations\DocLexer;
use ps_metrics_module_v4_0_5\PhpCsFixer\Preg;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Token as PhpToken;
/**
            ...
            if (0 !== $nbScannedTokensToUse) {
                ...
                foreach (\array_slice($scannedTokens, 0, $nbScannedTokensToUse) as $token) {
                    ...
                    if ($missingTextLength > 0) {
                        $tokens[] = new Token(DocLexer::T_NONE, \substr($content, $nextAtPosition + $lastTokenEndIndex, $missingTextLength));
                    }
