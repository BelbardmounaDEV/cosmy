 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer\FixerDefinition;
...
final class VersionSpecificCodeSample implements VersionSpecificCodeSampleInterface
{
    ...
    public function __construct(string $code, VersionSpecificationInterface $versionSpecification, ?array $configuration = null)
    {
