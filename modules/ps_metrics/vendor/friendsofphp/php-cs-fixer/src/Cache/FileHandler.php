 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer\Cache;
...
final class FileHandler implements FileHandlerInterface
{
    ...
    public function write(CacheInterface $cache) : void
    {
        ...
        if (\false === $bytesWritten) {
            ...
            throw new IOException(\sprintf('Failed to write file "%s", "%s".', $this->file, $error['message'] ?? 'no reason available'), 0, null, $this->file);
        }
    }
}
