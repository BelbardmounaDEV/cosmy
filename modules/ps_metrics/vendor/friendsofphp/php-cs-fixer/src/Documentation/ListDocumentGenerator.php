...
final class ListDocumentGenerator
{
    ...
    {
        \usort($fixers, static function (FixerInterface $fixer1, FixerInterface $fixer2) : int {
        ...
        foreach ($fixers as $fixer) {
            ...
            if ($fixer instanceof DeprecatedFixerInterface) {
                ...
                if (0 !== \count($alternatives)) {
                    $documentation .= RstUtils::toRst(\sprintf('   Use %s instead.', Utils::naturalLanguageJoinWithBackticks($alternatives)), 3);
                }
                $documentation .= "\n";
            }
            if ($fixer->isRisky()) {
