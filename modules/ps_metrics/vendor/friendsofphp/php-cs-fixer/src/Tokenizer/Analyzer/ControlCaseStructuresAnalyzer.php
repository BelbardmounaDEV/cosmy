...
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\AbstractControlCaseStructuresAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\CaseAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\DefaultAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\EnumAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\MatchAnalysis;
use ps_metrics_module_v4_0_5\PhpCsFixer\Tokenizer\Analyzer\Analysis\SwitchAnalysis;
...
final class ControlCaseStructuresAnalyzer
{
    ...
    public static function findControlStructures(Tokens $tokens, array $types) : \Generator
    {
        ...
        foreach ($types as $type) {
            if (!\in_array($type, $typesWithCaseOrDefault, \true)) {
        ...
        foreach ($tokens as $index => $token) {
            ...
            if (!$isTypeOfInterest) {
                continue;
                // don't bother to analyze stuff that caller is not interested in
            }
