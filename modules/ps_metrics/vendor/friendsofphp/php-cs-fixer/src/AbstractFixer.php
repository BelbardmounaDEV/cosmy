 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer;

use ps_metrics_module_v4_0_5\PhpCsFixer\ConfigurationException\InvalidFixerConfigurationException;
use ps_metrics_module_v4_0_5\PhpCsFixer\ConfigurationException\InvalidForEnvFixerConfigurationException;
use ps_metrics_module_v4_0_5\PhpCsFixer\ConfigurationException\RequiredFixerConfigurationException;
use ps_metrics_module_v4_0_5\PhpCsFixer\Console\Application;
...
abstract class AbstractFixer implements FixerInterface
{
    ...
    public final function fix(\SplFileInfo $file, Tokens $tokens) : void
    {
    ...
    protected abstract function applyFix(\SplFileInfo $file, Tokens $tokens) : void;
