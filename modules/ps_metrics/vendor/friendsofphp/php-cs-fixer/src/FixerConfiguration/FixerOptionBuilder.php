 ...
 */
namespace ps_metrics_module_v4_0_5\PhpCsFixer\FixerConfiguration;
...
final class FixerOptionBuilder
{
    ...
    {
        $option = new FixerOption($this->name, $this->description, $this->isRequired, $this->default, $this->allowedTypes, $this->allowedValues, $this->normalizer);
