...
final class SetSniffPropertyTest extends TestCase
{
    ...
    public function testSetPropertyAppliesPropertyToMultipleSniffsInCategory()
    {
        ...
        $sniffClass = 'ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Standards\\PEAR\\Sniffs\\Functions\\FunctionCallSignatureSniff';
        ...
        $sniffClass = 'ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Standards\\PEAR\\Sniffs\\Functions\\FunctionDeclarationSniff';
        $this->assertArrayHasKey($sniffClass, $ruleset->sniffs, 'Sniff class ' . $sniffClass . ' not listed in registered sniffs');
        $sniffObject = $ruleset->sniffs[$sniffClass];
        $this->assertSame($expectedValue, $sniffObject->{$propertyName}, 'Property value not set to expected value for ' . $sniffClass);
        // Test that the property doesn't get set for the one sniff which doesn't support the property.
        $sniffClass = 'ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Standards\\PEAR\\Sniffs\\Functions\\ValidDefaultValueSniff';
        $this->assertArrayHasKey($sniffClass, $ruleset->sniffs, 'Sniff class ' . $sniffClass . ' not listed in registered sniffs');
    ...
    {
        $exceptionClass = 'ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Exceptions\\RuntimeException';
    ...
    {
        $exceptionClass = 'ps_metrics_module_v4_0_5\\PHPUnit\\Framework\\Error\\Deprecated';
