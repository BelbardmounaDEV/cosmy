...
final class RuleInclusionAbsoluteWindowsTest extends TestCase
{
    ...
    public function testWindowsStylePathRuleInclusion()
    {
        ...
        $this->assertSame('ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterCastSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterCast']);
