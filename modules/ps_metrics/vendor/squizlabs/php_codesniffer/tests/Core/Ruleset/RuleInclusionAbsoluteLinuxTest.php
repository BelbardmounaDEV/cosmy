...
final class RuleInclusionAbsoluteLinuxTest extends TestCase
{
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
