 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Tests\Core\Tokenizer;
...
abstract class AbstractTokenizerTestCase extends TestCase
{
    ...
    {
        $property = new ReflectionProperty('ps_metrics_module_v4_0_5\\PHP_CodeSniffer\\Tokenizers\\PHP', 'resolveTokenCache');
