 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer;

use Exception;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Exceptions\DeepExitException;
...
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Files\FileList;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Util\Cache;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Util\Common;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Util\Standards;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Util\Timing;
...
class Runner
{
    ...
    public function processFile($file)
    {
        ...
        try {
            ...
            if (empty($sniffStack) === \false) {
                if (empty($nextStack) === \false && isset($nextStack['class']) === \true && \substr($nextStack['class'], -5) === 'Sniff') {
