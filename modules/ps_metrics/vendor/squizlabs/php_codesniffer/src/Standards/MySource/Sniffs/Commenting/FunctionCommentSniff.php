 ...
 * @deprecated 3.9.0
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\MySource\Sniffs\Commenting;

use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\Squiz\Sniffs\Commenting\FunctionCommentSniff as SquizFunctionCommentSniff;
...
class FunctionCommentSniff extends SquizFunctionCommentSniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        //end foreach
        if ($hasApiTag === \true && \substr($tokens[$tag]['content'], 0, 4) !== '@api') {
