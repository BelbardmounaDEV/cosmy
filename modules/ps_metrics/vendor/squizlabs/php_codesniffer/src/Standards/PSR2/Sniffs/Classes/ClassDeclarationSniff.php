 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes;

use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Files\File;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\PEAR\Sniffs\Classes\ClassDeclarationSniff as PEARClassDeclarationSniff;
...
class ClassDeclarationSniff extends PEARClassDeclarationSniff
{
    ...
    public function processOpen(File $phpcsFile, $stackPtr)
    {
        ...
        $classModifiers = [\T_ABSTRACT => \T_ABSTRACT, \T_FINAL => \T_FINAL, \T_READONLY => \T_READONLY];
        ...
        if (isset($classModifiers[$tokens[$prevNonEmpty]['code']]) === \true) {
            $spaces = 0;
