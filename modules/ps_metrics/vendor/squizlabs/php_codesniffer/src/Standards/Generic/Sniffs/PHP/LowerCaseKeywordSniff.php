...
class LowerCaseKeywordSniff implements Sniff
{
    ...
    public function register()
    {
        ...
        $targets += [T_CLOSURE => T_CLOSURE, \T_EMPTY => \T_EMPTY, T_ENUM_CASE => T_ENUM_CASE, \T_EVAL => \T_EVAL, \T_ISSET => \T_ISSET, T_MATCH_DEFAULT => T_MATCH_DEFAULT, T_PARENT => T_PARENT, T_SELF => T_SELF, \T_UNSET => \T_UNSET];
        return $targets;
    }
    //end register()
    /**
