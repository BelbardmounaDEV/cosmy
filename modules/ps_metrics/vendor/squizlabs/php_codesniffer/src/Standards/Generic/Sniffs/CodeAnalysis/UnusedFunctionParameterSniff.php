 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\Generic\Sniffs\CodeAnalysis;
...
class UnusedFunctionParameterSniff implements Sniff
{
     ...
     * @var array
     */
    private $magicMethods = ['__destruct' => \true, '__call' => \true, '__callstatic' => \true, '__get' => \true, '__set' => \true, '__isset' => \true, '__unset' => \true, '__sleep' => \true, '__wakeup' => \true, '__serialize' => \true, '__unserialize' => \true, '__tostring' => \true, '__set_state' => \true, '__clone' => \true, '__debuginfo' => \true];
    /**
        ...
        if ($token['code'] === \T_FUNCTION) {
            ...
            if ($classPtr !== \false) {
                ...
                if (empty($methodName) === \false) {
                    ...
                    if (isset($this->magicMethods[$methodNameLc]) === \true) {
                        return;
                    }
                }
            ...
            if ($code === \T_VARIABLE && isset($params[$token['content']]) === \true) {
                ...
                if ($code === T_DOLLAR) {
                    ...
                    if ($code === T_DOUBLE_QUOTED_STRING || $code === \T_START_HEREDOC || $code === T_START_NOWDOC) {
                        ...
                        $stringTokens = \token_get_all(\sprintf('<?php %s;?>', $content));
