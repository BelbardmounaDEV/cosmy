 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\Generic\Sniffs\Classes;
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        while ($stackPtr !== \false) {
            ...
            if ($tokens[$stackPtr]['code'] === \T_NAMESPACE) {
                $nsEnd = $phpcsFile->findNext([\T_NS_SEPARATOR, \T_STRING, \T_WHITESPACE], $stackPtr + 1, null, \true);
                $namespace = \trim($phpcsFile->getTokensAsString($stackPtr + 1, $nsEnd - $stackPtr - 1));
                $stackPtr = $nsEnd;
            } else {
