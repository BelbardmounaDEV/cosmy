...
class NonExecutableCodeSniff implements Sniff
{
     ...
     * @var array
     */
    private $expressionTokens = [\T_EXIT => \T_EXIT, \T_THROW => \T_THROW];
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($this->expressionTokens[$tokens[$stackPtr]['code']]) === \true) {
            ...
            if (isset(Tokens::$booleanOperators[$tokens[$prev]['code']]) === \true && ($tokens[$stackPtr]['code'] === \T_THROW && $tokens[$prev]['code'] === \T_LOGICAL_XOR) === \false) {
                return;
            }
