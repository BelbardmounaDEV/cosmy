...
class DisallowSizeFunctionsInLoopsSniff implements Sniff
{
     ...
     * @var array
     */
    protected $forbiddenFunctions = ['PHP' => ['sizeof' => \true, 'strlen' => \true, 'count' => \true], 'JS' => ['length' => \true]];
    /**
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        for ($i = $start + 1; $i < $end; $i++) {
            if ($tokens[$i]['code'] === \T_STRING && isset($this->forbiddenFunctions[$tokenizer][$tokens[$i]['content']]) === \true) {
