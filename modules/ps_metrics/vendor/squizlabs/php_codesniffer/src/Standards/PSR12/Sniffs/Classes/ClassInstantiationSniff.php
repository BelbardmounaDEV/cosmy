 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Standards\PSR12\Sniffs\Classes;
...
class ClassInstantiationSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        // Find the class name.
        $allowed = [\T_STRING => \T_STRING, \T_NS_SEPARATOR => \T_NS_SEPARATOR, T_SELF => T_SELF, \T_STATIC => \T_STATIC, T_PARENT => T_PARENT, \T_VARIABLE => \T_VARIABLE, T_DOLLAR => T_DOLLAR, \T_OBJECT_OPERATOR => \T_OBJECT_OPERATOR, \T_NULLSAFE_OBJECT_OPERATOR => \T_NULLSAFE_OBJECT_OPERATOR, \T_DOUBLE_COLON => \T_DOUBLE_COLON];
        ...
        for ($i = $stackPtr + 1; $i < $phpcsFile->numTokens; $i++) {
            ...
            if ($tokens[$i]['code'] === \T_ATTRIBUTE || $tokens[$i]['code'] === \T_READONLY || $tokens[$i]['code'] === T_ANON_CLASS) {
                return;
            }
