 ...
 */
namespace ps_metrics_module_v4_0_5\PHP_CodeSniffer\Files;

use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Config;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Exceptions\RuntimeException;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Exceptions\TokenizerException;
use ps_metrics_module_v4_0_5\PHP_CodeSniffer\Fixer;
...
class File
{
    ...
    public function getMemberProperties($stackPtr)
    {
        ...
        if (isset($this->tokens[$ptr]) === \false || $this->tokens[$ptr]['code'] !== \T_CLASS && $this->tokens[$ptr]['code'] !== T_ANON_CLASS && $this->tokens[$ptr]['code'] !== \T_TRAIT) {
            if (isset($this->tokens[$ptr]) === \true && ($this->tokens[$ptr]['code'] === \T_INTERFACE || $this->tokens[$ptr]['code'] === \T_ENUM)) {
        ...
        //end if
        return ['scope' => $scope, 'scope_specified' => $scopeSpecified, 'is_static' => $isStatic, 'is_readonly' => $isReadonly, 'type' => $type, 'type_token' => $typeToken, 'type_end_token' => $typeEndToken, 'nullable_type' => $nullableType];
    }
    ...
    public function findStartOfStatement($start, $ignore = null)
    {
        ...
        if ($matchExpression !== \false) {
            ...
            if ($this->tokens[$prevMatch]['code'] === T_COMMA) {
                ...
                $next = $this->findNext(Tokens::$emptyTokens, $end + 1, null, \true);
                return $next;
            }
        }
        //end if
