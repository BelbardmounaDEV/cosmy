...
class UnicodeString extends \Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function append(string ...$suffix) : \Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function join(array $strings, ?string $lastGlue = null) : \Symfony\Component\String\AbstractString
    {
    ...
    public function prepend(string ...$prefix) : \Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replace(string $from, string $to) : \Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function replaceMatches(string $fromRegexp, $to) : \Symfony\Component\String\AbstractString
    {
        $str = parent::replaceMatches($fromRegexp, $to);
        \normalizer_is_normalized($str->string) ?: ($str->string = \normalizer_normalize($str->string));
        return $str;
    }
    public function slice(int $start = 0, ?int $length = null) : \Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    public function splice(string $replacement, int $start = 0, ?int $length = null) : \Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
