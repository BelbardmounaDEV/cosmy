...
namespace ps_metrics_module_v4_0_5\PhpParser\Lexer;

use ps_metrics_module_v4_0_5\PhpParser\Error;
use ps_metrics_module_v4_0_5\PhpParser\ErrorHandler;
use ps_metrics_module_v4_0_5\PhpParser\Lexer;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ps_metrics_module_v4_0_5\PhpParser\Lexer\TokenEmulator\TokenEmulator;
